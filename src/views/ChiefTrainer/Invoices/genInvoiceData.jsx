...
class AllStudents extends React.Component {
  ...
  componentDidMount = () => {
    if (this.props.location.state.selectedUsers.length == 0) {
      this.props.history.push(`/${this.props.global.user.role}/invoices`)
    }
  };

  render = () => {
    const { selectedUsers } = this.props.location.state;
    console.log('gotSudents', selectedUsers)
