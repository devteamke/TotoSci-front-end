      ...
      <div>
        ...
        <GridContainer>
          <GridItem xs={12} sm={12} md={11}>
            <Card title='Add a new user' style={{ width: '100%' }}>
              ...
              <GridItem xs={12} sm={12} md={12}>
                <Form {...formItemLayout} onSubmit={this.handleSubmit}>
                  <Form.Item label='Role'>
                    {getFieldDecorator('role', {
                      ...
                      >
                        ...
                        <Radio value={'manager'}>Management</Radio>
                        <Radio value={'chief-trainer'}>Chief Trainer</Radio>
                  ...
                  {state.role == 'trainer' || state.role == 'instructor' ? (
