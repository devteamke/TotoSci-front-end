...
import { MDBAlert, MDBCard, MDBCol,  MDBContainer, MDBRow,  MDBInput, MDBBtn, MDBIcon } from 'mdbreact';
        ...
        />
  							...
  							<GridContainer>
								...
								<GridItem xs={12} sm={12} md={12} >
								 	...
								 	<div className="text-center">
										<h5>Your are almost there, complete your profile to continue...</h5>
									 	<MDBIcon style={{margin:'1rem auto'}}icon="user-circle" className="blue-grey-text"  size="9x" />
			  ...
			  <GridItem xs={12} sm={12} md={6}>
	 		  ...
	 		  <GridContainer>
				  <GridItem xs={12} sm={12} md={12}>
					<div className="text-center">
				 {state.savingInfo?  <div className="spinner-grow text-info" role="status" style={{marginBottom:'15px'}}>
					<span className="sr-only">Loading...</span>
				  </div> :<MDBBtn onClick={this.handleSubmit}> Continue </MDBBtn>}
				</div>
				   </GridItem>
			</GridContainer>
