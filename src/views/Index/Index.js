                                ...
                                <div className="row">
                                    <div className="col-md-8 col-sm-8 col-xs-12">
                                        ...
                                        <ul className="contact">
                                            <li><i className="fa fa-headphones"></i> +(123) 45678910</li>
                                            <li><i className="fa fa-envelope"></i> <a href="mailto:info@yourmail.com">info@yourmail.com</a></li>
                                        </ul>
                                        {/* <!--/ End Contact --> */}
                                    </div>
                                    <div className="col-md-4 col-sm-4 col-xs-12">
                                        ...
                                        <ul className="social">
                                            ...
                                            <li className="active"><a href="#"><i className="fa fa-facebook"></i></a></li>
                ...
                <div className="container">
                    <div className="row">
                        ...
                        <div className="col-md-10 col-sm-12 col-xs-12">
                            ...
                            {/* <!-- Search Form--> */}
                            <ul className="search">
                                <li><a href="#header"><i className="fa fa-search"></i></a></li>
                            </ul>	
                            <div className="search-form">
                                <form className="form" action="#">
                                    <input type="search" placeholder="search here"/>
                                    <button type="submit" value="send"><i className="fa fa-search"></i></button>
                                </form>
                            </div>
                            {/* <!--/ End Search Form --> */}
                        </div>
                        ...
                        <div className="row">
                            <div className="col-md-12 col-sm-12 col-xs-12">
                                ...
                                <div className="slide-text">
                                    <h1>Welcome to <span>Tromas</span></h1>
                                    <p>Pellentesque fringilla faucibus sem a pellentesque. Phasellus aliquet commodo odio, sed interdum nibh interdum id. Integer diam urna, viverra vel purus non, blandit tincidunt risus. Aenean vitae suscipit metus.</p>
                                    <div className="slide-btn">	
                                        <a href="#project" className="btn primary"><i className="fa fa-long-arrow-down"></i>View Projects</a>
                                    </div>
                                </div>
                                {/* <!--/ End SLider Text --> */}
                            </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12 col-sm-12 col-xs-12">
                                {/* <!-- Slider Text --> */}
                                <div className="slide-text">
                                    <h1>Your are <span>Right</span> Place</h1>
                                    <p>Pellentesque fringilla faucibus sem a pellentesque. Phasellus aliquet commodo odio, sed interdum nibh interdum id. Integer diam urna, viverra vel purus non, blandit tincidunt risus. Aenean vitae suscipit metus.</p>
                                    <div className="slide-btn">	
                                        <a href="blog.html" className="btn primary"><i className="fa fa-long-arrow-left"></i>Our Blog</a>
                                    </div>
                                </div>
                                {/* <!--/ End SLider Text --> */}
                            </div>
                    ...
                    <div className="container">
                        <div className="row">
                            <div className="col-md-12 col-sm-12 col-xs-12">
                                {/* <!-- Slider Text --> */}
                                <div className="slide-text">
                                    <h1>Digital Business <span>World</span></h1>
                                    <p>Pellentesque fringilla faucibus sem a pellentesque. Phasellus aliquet commodo odio, sed interdum nibh interdum id. Integer diam urna, viverra vel purus non, blandit tincidunt risus. Aenean vitae suscipit metus.</p>
                                    <div className="slide-btn">	
                                        <a href="contact.html" className="btn primary"><i className="fa fa-long-arrow-left"></i>Contact Us</a>
                                    </div>
                                </div>
                                {/* <!--/ End SLider Text --> */}
                            </div>
