  ...
  return (
              ...
              <GridItem xs={12} sm={12} md={12}>
                  ...
                  <MDBInput
				    ...
				    onChange={(event)=>{ this.setState({salutation:event.target.value,alt_phone_numberError:validate('alt_phone', event.target.value==''?null:event.target.value)})}}
			    ...
			    <GridItem xs={12} sm={12} md={6}>
                   <MDBInput
					...
					value={state.alt_phone_number}
					 onChange={(event)=>{ this.setState({alt_phone_number:event.target.value})}}
